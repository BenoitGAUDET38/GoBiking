 ...
 *       &lt;sequence&gt;
 *         &lt;element name="GetItinaryResult" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetItinaryResponse {
    ...
    /**
     * Obtient la valeur de la propriété getItinaryResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Définit la valeur de la propriété getItinaryResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
